...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="https://pvrs.s3.amazonaws.com/lg.png" sizes="32x32">
  <!-- Favicons-->
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="https://pvrs.s3.amazonaws.com/lg.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                <div class="col col s4 m4 l4">
                    <img src="https://pvrs.s3.amazonaws.com/user-bg.jpg" alt="" class="circle responsive-img valign profile-image">
                </div>
