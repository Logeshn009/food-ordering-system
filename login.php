...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="http://ec2-3-92-226-193.compute-1.amazonaws.com/fs/login.php" sizes="32x32">
  <!-- Favicons-->
...
<video autoplay muted loop id="myVideo">
  <source src="https://pvrs.s3.amazonaws.com/v2.mp4" type="video/mp4">
</video>
  <!-- Start Page Loading -->
      ...
      <form method="post" action="routers/router.php" class="login-form" id="form">
        <div class="row">
          <div class="input-field col s12 center">
            <p class="center login-form-text">FOODIES</p>
          </div>
        </div>
