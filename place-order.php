...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="https://pvrs.s3.amazonaws.com/lg.png
" sizes="32x32">
  <!-- Favicons-->
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="https://pvrs.s3.amazonaws.com/lg.png
" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
